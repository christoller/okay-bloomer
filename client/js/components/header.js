function renderHeader(session = {}) {
    ...
    if (session.username) {
        ...
        <ul id="navlist" class="flex m-auto justify-center ">
            ...
            <li class="hidden md:contents">|</li>
            <li onClick="viewPlantFavourites()" class="px-8 cursor-pointer hover:text-green-800 ease-in duration-200 hover:underline hover:font-bold hover:scale-110"">View your favourites</li>
            <li class="hidden md:contents">|</li>
